...
Figure~\ref{fig:arch} shows the architecture, implemented on the $\pi_{0.5}$ backbone within the MME-VLA codebase. We give each representation its strongest integration mechanism as identified by RoboMME:
